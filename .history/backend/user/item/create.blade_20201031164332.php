    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    @if($category_id > 0)
                    <form method="POST" action="{{ route('user.items.store') }}" id="item-create-form" enctype="multipart/form-data">
                        @csrf
                        <hr/>
...
">
            ...
            @if(Request::fullUrl() === 'https://yasta.net/user/items/create?category=7' or !Auth::user()->Type==="1")
