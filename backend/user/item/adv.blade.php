...
<div class="row justify-content-between">
    <div class="col-9">
<form action="{{route('user.invitations')}}" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- ##########################(from bg)################################### --}}
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select class="form-control" id="sel1" name="users">
            ...
            @foreach(DB::table('users')->orderBy('id','desc')->where('Type', '2')->where('Type', '3')->get() as $item_research_project)
    ...
    <input type="submit" style="background: #011a25;" class="btn btn-primary btn-large btn-block"
      value="ارسال الدعوة " />
    <br>
    <a  href="{{ route('user.msg') }}" class="btn btn-primary active">عرض الدعوات</a>
